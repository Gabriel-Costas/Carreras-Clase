...
equipos = []
resultados = []
for i in range(0,total_equipos):
	partido = []
	partido.append(input("Introduce el nombre del equipo 1 del partido %d: " % (i+1)))
	partido.append(input("Introduce el nombre del equipo 2 del partido %d: " % (i+1)))
